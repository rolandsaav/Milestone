        ...
        <KeyboardAvoidingContainer style={styles.container}>
            ...
            ></InputTextField>
                ...
                <TouchableOpacity style={styles.submitContainer}>
                    <Text style={[styles.text, { color: "#fff", fontWeight: "600", fontSize: 16 }]} onPress={onLogin}>Login</Text>
                </TouchableOpacity>

                <Text style={[styles.text, { fontSize: 14, color: "#ABB4BD", textAlign: "center", marginTop: 24 }]} onPress={() => { navigation.navigate("Register") }}>
